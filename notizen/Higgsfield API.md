...
- **Stand 26.09., 17:37:** Schlüssel eingetragen, erster Test erfolgreich – Z-Image Turbo 1k, Preis laut API 0,015 $ (0,24 API-Credits), Bild `api_f13c7922_api-test-tasse` in der [[Higgsfield-Galerie]]. **Cashback bestätigt:** im Personal-Konto unter Usage „Cashback wallet −0,02 $ Completed“ (0,015 $ gerundet), Hauptguthaben unverändert 7,44 $. „Organization balance 0,22 $“ gehört zur (inaktiven) Organisation und ist davon unabhängig.
